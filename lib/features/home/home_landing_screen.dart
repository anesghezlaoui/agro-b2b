                    ...
                    return Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final count = catalog.productCountInMain(name);
                          final img = catalog.representativeImageForMain(name) ??
                ...
                SliverList.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        '${p.price.toStringAsFixed(0)} DA • Stock ${p.stock}',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                      // FilledButton.tonal a une largeur min. trop grande pour ListTile (web) → layout cassé.
          ...
          children: [
            Positioned.fill(
              child: Opacity(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      'https://picsum.photos/seed/agrohero/1200/500',
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Commandez rapidement vos produits au meilleur prix',
                  ...
                  Text(
                    'Catalogue clair, commande terrain, pensé pour les pros.',
